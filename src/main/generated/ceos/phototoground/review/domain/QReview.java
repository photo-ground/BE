...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = -1917387090L;
    ...
    public final ceos.phototoground.reservation.domain.QReservation reservation;
    ...
    public QReview(Class<? extends Review> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reservation = inits.isInitialized("reservation") ? new ceos.phototoground.reservation.domain.QReservation(forProperty("reservation"), inits.get("reservation")) : null;
    }
