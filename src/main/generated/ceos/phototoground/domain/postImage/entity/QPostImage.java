package ceos.phototoground.domain.postImage.entity;
...
public class QPostImage extends EntityPathBase<PostImage> {
    ...
    private static final long serialVersionUID = -801210133L;
    ...
    public final ceos.phototoground.domain.post.entity.QPost post;

    public final ceos.phototoground.domain.spot.entity.QSpot spot;
    ...
    public QPostImage(Class<? extends PostImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new ceos.phototoground.domain.post.entity.QPost(forProperty("post"), inits.get("post")) : null;
        this.spot = inits.isInitialized("spot") ? new ceos.phototoground.domain.spot.entity.QSpot(forProperty("spot"), inits.get("spot")) : null;
    }
